...
##Python:  3.9.1
##
##Author: Daniel A Christie (Re-created by Nick Pranno)
##
...
##         Return variable means that we are returning the variable back to the
##         calling function.
...
def reset(nice,mean,name):
    nice = 0
    mean = 0
    #notice i dont not reset the name variable as that user has elected to play again
